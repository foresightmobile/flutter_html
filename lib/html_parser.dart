...
class HtmlParser extends StatelessWidget {
  ...
  })  : this._onAnchorTap = key != null ? _handleAnchorTap(key, onLinkTap) : null,
        super(key: key);
            ...
            children: [
              ...
              Expanded(
                  child: Padding(
                      ...
                      child: StyledText(
                        textSpan: TextSpan(
                          text: (tree.style.listStylePosition == ListStylePosition.INSIDE) ? '${newContext.style.markerContent}' : null,
      ...
      InlineSpan addTaps(InlineSpan childSpan, TextStyle childStyle) {
        if (childSpan is TextSpan) {
          return TextSpan(
            ...
            style: newContext.style.generateTextStyle().merge(childSpan.style == null ? childStyle : childStyle.merge(childSpan.style)),
            semanticsLabel: childSpan.semanticsLabel,
            recognizer: TapGestureRecognizer()
              ..onTap = _onAnchorTap != null ? () => _onAnchorTap(tree.href, context, tree.attributes, tree.element) : null,
          );
        } else {
          return WidgetSpan(
            child: RawGestureDetector(
              ...
              gestures: {
                MultipleTapGestureRecognizer: GestureRecognizerFactoryWithHandlers<MultipleTapGestureRecognizer>(
                  ...
                  (instance) {
                    instance..onTap = _onAnchorTap != null ? () => _onAnchorTap(tree.href, context, tree.attributes, tree.element) : null;
                  },
                ),
              },
  ...
  static StyledElement _processBeforesAndAfters(StyledElement tree) {
    if (tree.style.before != null) {
      tree.children.insert(0, TextContentElement(text: tree.style.before, style: tree.style.copyWith(display: Display.INLINE)));
    }
    if (tree.style.after != null) {
      tree.children.add(TextContentElement(text: tree.style.after, style: tree.style.copyWith(display: Display.INLINE)));
    }
